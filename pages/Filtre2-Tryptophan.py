...
if 'reset' not in st.session_state or sidebar_reinitialize_button or st.session_state.pageNumber != 2:
    ...
    st.session_state.filter = 'Filtre 2 : Tryptophan'
    st.session_state.pageNumber = 2
...
if st.session_state.step == 2 and 'selected_mode' in st.session_state:
    ...
    images = {
        "Image Muscle Sain":"Ressources/GR_327-353_fluo_000.tif",
        "Image Muscle Malade":"Ressources/GRMD_327-353_fluo_000.tif",
        "Image Muscle Traité":"Ressources/GRMDT_327-353_fluo_000.tif"
    }
