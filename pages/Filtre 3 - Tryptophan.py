...
if 'reset' not in st.session_state or sidebar_reinitialize_button or st.session_state.pageNumber != 3:
    ...
    st.session_state.filter = 'Filtre 3 : Tryptophan'
...
if st.session_state.step == 2 and 'selected_mode' in st.session_state:
    ...
    images = {
        "Image Muscle Sain":"Ressources/GR_370-410_fluo_000.tif",
        "Image Muscle Malade":"Ressources/GRMD_370-410_fluo_000.tif",
        "Image Muscle Traité":"Ressources/GRMDT_370-410_fluo_000.tif"
    }
