...
if 'reset' not in st.session_state or sidebar_reinitialize_button or st.session_state.pageNumber != 5:
    ...
    st.session_state.filter = 'Filtre 5 : Collagen'
    st.session_state.pageNumber = 5
...
if st.session_state.step == 2 and 'selected_mode' in st.session_state:
    ...
    images = {
        "Image Muscle Sain":"Ressources/GR_435-455_fluo_000.tif",
        "Image Muscle Malade":"Ressources/GRMD_435-455_fluo_000.tif",
        "Image Muscle Traité":"Ressources/GMDT_435-455_fluo_000.tif"
    }
