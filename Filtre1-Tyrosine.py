...
if 'reset' not in st.session_state or sidebar_reinitialize_button or st.session_state.pageNumber != 1:
    ...
    st.session_state.filter = 'Filtre 1 : Tyrosine'
...
if st.session_state.step == 2 and 'selected_mode' in st.session_state:
    ...
    images = {
        "Image Muscle Sain":"Ressources/GR_300_307-323_fluo_000.tif",
        "Image Muscle Malade":"Ressources/GRMD_307-323_fluo_000.tif",
        "Image Muscle Traité":"Ressources/GRMDT_307-323_fluo_000.tif"
    }
